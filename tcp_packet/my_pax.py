...
class TCPPacket:
    def __init__(self, dport = 80, sport = 65535, dst='127.0.0.1',
        src='192.168.1.101', data = 'Nothing'):
        self.dport = dport
        self.sport = sport
        self.src_ip = src
        self.dst_ip = dst
    ...
    def calculate_chksum(self):
        ...
        # call CheckSum calculation function
        self.tcp_chksum = self.chksum(psh)
        # finally, reassemble all peice of information
        self.reassemble_tcp_feilds()n
        return
